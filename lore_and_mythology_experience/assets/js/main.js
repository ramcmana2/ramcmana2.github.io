...
function showAnnibale() {
    ...
    var annibale_img = document.getElementById("annibale");
    annibale_img.setAttribute("style", "background-color: transparent; width: 50vw; height: calc(1.25 * 50vw); border-radius: 12px; position: relative; top: calc(((100vh - 1.25 * 50vw) / 2) / 2); left: calc((100vw - 50vw) / 2);");
