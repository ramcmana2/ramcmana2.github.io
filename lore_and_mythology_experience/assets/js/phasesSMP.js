...
export function startPhasesSMP(phasesAudioManager) {
    ...
    for (var i = 0; i < taps.length; i++) {
        ...
        taps[i].setAttribute("style", "position: absolute; top: calc(1.77 * (100vh - 70vh)); left: calc((100vw / 2) - (0.185 * 0.7 * 70vh)); font-family: Arial, Helvetica, sans-serif; color: #333;");
    }
