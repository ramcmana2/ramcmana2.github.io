...
export function startPhasesSMP(phasesAudioManager) {
    ...
    document.getElementById("close_help").setAttribute("style", "position: absolute; top: calc(((100vh - 70vh) / 2) + (2 * (0.09 * 0.7 * 70vh)); left: calc((100vw / 2) + (70vh / 4)); font-family: Arial, Helvetica, sans-serif; color: #333; font-size: calc(0.09 * 0.7 * 70vh); cursor: pointer;");
    ...
    document.getElementById("help_modal_title").setAttribute("style", "position: absolute; top: calc(((100vh - 70vh) / 2) + (2 * (0.11 * 0.7 * 70vh))); left: calc((100vw / 2) - (2.5 * 0.35 * 0.11 * 0.7 * 70vh)); font-family: Arial, Helvetica, sans-serif; color: #333; font-size: calc(0.11 * 0.7 * 70vh);");
    ...
    for (var i = 0; i < taps.length; i++) {
        ...
        taps[i].setAttribute("style", "position: absolute; top: calc(1.8 * (100vh - 70vh)); left: calc((100vw / 2) - (0.18 * 0.7 * 70vh)); font-family: Arial, Helvetica, sans-serif; color: #333;");
    }
