...
export function startPhasesSMP(phasesAudioManager) {
    ...
    document.getElementById("papyrus_horizontal").setAttribute("style", "background-color: rgba(229, 243, 255, 0.9); border-radius: 15px; width: calc(0.7 * 80vh); height: 80vh; position: relative; top: calc((100vh - 80vh) / 2); left: calc((100vw - (0.7 * 80vh)) / 2);");
    document.getElementById("close_help").setAttribute("style", "position: absolute; top: calc(100vh - 80vh - ((0.09 * 0.7 * 80vh) / 2)); left: calc((100vw / 2) + ((0.8 * 80vh) / 4)); font-family: Arial, Helvetica, sans-serif; color: #333; font-size: calc(0.09 * 0.7 * 80vh); cursor: pointer;");
    document.getElementById("help_modal_title").setAttribute("style", "position: absolute; top: calc(100vh - 80vh + ((0.11 * 0.7 * 80vh) / 2)); left: calc((100vw / 2) - (4 * 0.35 * 0.11 * 0.7 * 80vh)); font-family: Arial, Helvetica, sans-serif; color: #333; font-size: calc(0.11 * 0.7 * 80vh);");
    var swipes = document.getElementsByClassName("swipe");
    for (var i = 0; i < swipes.length; i++) {
        swipes[i].setAttribute("style", "position: absolute; top: calc(3.3 * (100vh - 80vh)); left: calc((100vw / 2) - (0.7 * 80vh / 2) + (0.22 * 0.7 * 80vh)); display: flex; flex-direction: column; font-family: Arial, Helvetica, sans-serif; color: #333;");
    }
    var taps = document.getElementsByClassName("tap");
    for (var i = 0; i < taps.length; i++) {
        taps[i].setAttribute("style", "position: absolute; top: calc(3.17 * (100vh - 80vh)); left: calc((100vw / 2) + (0.7 * 80vh / 2) - (0.46 * 0.7 * 80vh)); display: flex; flex-direction: column; font-family: Arial, Helvetica, sans-serif; color: #333;");
    }
