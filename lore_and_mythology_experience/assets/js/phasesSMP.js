...
export function startPhasesSMP(phasesAudioManager) {
    ...
    document.getElementById("close_help").setAttribute("style", "position: absolute; top: calc(((100vh - 70vh) / 2) + ((0.7 * 70vh) / 6)); left: calc((100vw / 2) + ((0.7 * 70vh) / 2) - ((0.7 * 70vh) / 6)); font-family: Arial, Helvetica, sans-serif; font-size: 30px; font-weight: bold; cursor: pointer;");
    ...
    document.getElementById("help_modal_title").setAttribute("style", "position: absolute; top: calc(((100vh - 70vh) / 2) + ((0.7 * 70vh) / 5));; left: calc((100vw / 2) - (49.37px / 2)); font-family: Arial, Helvetica, sans-serif; font-size: 24px;");
    ...
    for (var j = 0; j < taps.length; j++) {
        ...
        taps[j].setAttribute("style", "position: absolute; top: calc(((100vh - 70vh) / 2) + 70vh - ((0.3 * 0.7 * 71.98vh) + 32)); left: calc((100vw / 2) - ((0.58 * 0.7 * 70vh) / 2) + 0.6vh); font-family: Arial, Helvetica, sans-serif;");
    }
