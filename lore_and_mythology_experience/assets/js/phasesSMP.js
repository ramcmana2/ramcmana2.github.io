...
export function startPhasesSMP(phasesAudioManager) {
    ...
    document.getElementById("close_help").setAttribute("style", "position: absolute; top: calc(((100vh - 70vh) / 2) + (0.07 * 0.7 * 70vh)); left: calc((100vw / 2) + (70vh / 4.1)); font-family: Arial, Helvetica, sans-serif; font-size: 30px; font-weight: bold; cursor: pointer;");
    ...
    document.getElementById("help_modal_title").setAttribute("style", "position: absolute; top: calc(((100vh - 70vh) / 2) + (0.1 * 0.7 * 70vh)); left: calc((100vw / 2) - (0.06 * 0.7 * 70vh)); font-family: Arial, Helvetica, sans-serif; font-size: 24px;");
    ...
    for (var j = 0; j < taps.length; j++) {
        ...
        taps[j].setAttribute("style", "position: absolute; top: calc(2.5 * (100vh - 70vh)); left: calc((100vw / 2) - (0.25 * 0.7 * 70vh)); font-family: Arial, Helvetica, sans-serif;");
    }
