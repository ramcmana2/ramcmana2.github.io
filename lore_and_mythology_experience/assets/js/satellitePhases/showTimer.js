    ...
    let intervalID = setInterval(function() {
        ...
        if (counter === 0) {
            ...
            nextButton.setAttribute("style", `
                ...
                display: block;
            `);
            nextButton.addEventListener("click", function() {incrementProgressBar(15); console.log(15); triggered("timer"); clearInterval(intervalID); document.getElementById("phase_modal").remove(); showPhase(phaseValues[phaseIndex]);});
